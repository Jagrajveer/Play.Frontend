...
window.CATALOG_SERVICE_URL = 'https://localhost:7185'
window.CATALOG_ITEMS_API_URL = `${window.CATALOG_SERVICE_URL}/items`
window.INVENTORY_SERVICE_URL = 'https://localhost:7174'
window.INVENTORY_ITEMS_API_URL = `${window.INVENTORY_SERVICE_URL}/items`
window.User_Service_URL = 'https://localhost:7010'
window.User_Service_API_URL = `${window.User_Service_URL}/users`
